...
<nav class="hk-breadcrumb" aria-label="breadcrumb">
    <ol class="breadcrumb breadcrumb-light bg-transparent">
        ...
        <li class="breadcrumb-item active" aria-current="page">Empresas Ativas</li>
    </ol>
</nav>
<!-- /Breadcrumb -->
                        ...
                        <div class="table-wrap">
                            <table id="datable_1" class="table w-100 display pb-30">
                                ...
                                <tr>
                                    ...
                                    <td><?=$store['slug']?></td>
                                    <td>
                                        <a class="btn btn-primary btn-xs" href="<?=url('store/details/'.$store['id'].'/active')?>">Detalhes</a>
                                        <a class="btn btn-danger btn-xs" href="<?=url('store/desactive/'.$store['id'])?>">Desativar</a>
                                    </td>
                                </tr>
