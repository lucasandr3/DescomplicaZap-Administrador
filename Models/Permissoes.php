...
class Permissoes extends Model
{
	...
	public function getAllGroups()
	{
		...
		$sql ="SELECT permission_groups.*, (select count(Users.id_user) from Users where Users.id_permissao = permission_groups.id_group) as total_users FROM permission_groups";
		$sql = $this->db->query($sql);
	...
	{
		$sql ="SELECT id_user FROM Users WHERE id_permissao = :id_group";
		$sql = $this->db->prepare($sql);
